...
--
-- Dumping events for database 'fudbalskaliga-hci'
--

--
-- Dumping routines for database 'fudbalskaliga-hci'
--
...
begin
    ...
    inner join utakmica u on knu.UtakmicaId=u.UtakmicaId
    where u.BrojKola=pKolo and knu.KlubId=pKlubId;
end ;;
DELIMITER ;
...
begin
	set fixture=-1;
    select u.BrojKola into fixture
    from utakmica u 
...
-- Dump completed on 2023-11-10 19:54:35
